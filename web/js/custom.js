...
$MENU_TOGGLE.on('click', function() {
	...
	// check active menu
	$SIDEBAR_MENU.find('a[href="' + CURRENT_URL.toLowerCase() + '"]').parent('li').addClass('current-page');
