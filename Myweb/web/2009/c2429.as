function load_image(imagem, clip)
{
    ...
    _loc1.onLoadStart = function ()
    {
        ...
        mov_maskloader._width = 0;
        mov_maskloader._height = 0;
    };
    _loc1.onLoadProgress = function (m_clip, bytesLoaded, bytesTotal)
    {
        mov_imgloader._width = mov_imgloader._width + Math.round((Math.round(bytesLoaded / bytesTotal * 445) - mov_imgloader._width) / 8);
    ...
    {
        mov_imgloader._width = 445;
        mov_imgloader.alphaTo(0, 3.000000E-001, "linear");
        mov_maskloader.scaleTo(100, 1);
...
phone_title.text.colorTo(_global.color_on, 0);
email_title.text.colorTo(_global.color_on, 0);
sendit_title.text.colorTo(_global.color_on, 0);
mov_imgloader.colorTo(_global.color_on, 0);
var xml_file = new XML();
xml_file.ignoreWhite = true;
xml_file.onLoad = function ()
{
    load_image(xml_file.firstChild.firstChild.attributes.image, mov_holder);
    title_txt.text = xml_file.firstChild.firstChild.attributes.title;
    adress1_txt.text = xml_file.firstChild.firstChild.attributes.line1;
    adress2_txt.text = xml_file.firstChild.firstChild.attributes.line2;
    ...
    email_txt.autoSize = "left";
    but_send_mail._width = email_txt._width;
    phone_title.colorTo(_global.color_on, 0);
    email_title.colorTo(_global.color_on, 0);
};
xml_file.load("contact.xml");
but_send_mail.onRollOver = function ()
{
    email_txt.colorTo(_global.color_on, 4.000000E-001);
};
but_send_mail.onRollOut = function ()
{
    email_txt.colorTo(16777215, 4.000000E-001);
};
but_send_mail.onRelease = function ()
{
    getURL("mailto:" + txt_email, "");
};
