function align_services()
{
    ...
    but_next._x = Math.round(Number(mov_content._parent._parent._parent.xml_file.firstChild.childNodes[mov_content._parent._parent._parent.relative_pos].attributes.or_width) + 20);
    mov_set_buttons._x = -mov_content._parent._parent._x - mov_content._parent._x + _global.menu_xmargin;
    mov_set_buttons._y = -mov_content._parent._parent._y - mov_content._parent._y + _global.menu_ymargin;
} // End of the function
function recreate_right_panel(new_pos)
{
    for (i = 0; i < xml_file.firstChild.childNodes[main_position].childNodes.length; i++)
    {
        removeMovieClip (mov_content.mov_videos.mov_entries["mov_entry" + i]);
    } // end of for
    main_position = new_pos;
    mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + main_position].colorTo(_global.color_on, 1.000000E-001, "linear");
    var _loc4 = xml_file.firstChild.childNodes[new_pos];
    var _loc3 = _loc4.childNodes;
    title_txt.text = _loc4.attributes.title;
    var i = 0;
    while (i < _loc3.length)
    {
        mov_content.mov_videos.mov_entries.mov_entry.duplicateMovieClip("mov_entry" + i, i);
        mov_content.mov_videos.mov_entries["mov_entry" + i]._x = 0;
        mov_content.mov_videos.mov_entries["mov_entry" + i]._y = i * (mov_content.mov_videos.mov_entries.mov_entry._height - 1);
        mov_content.mov_videos.mov_entries["mov_entry" + i]._alpha = 60;
        mov_content.mov_videos.mov_entries["mov_entry" + i].body_txt.htmlText = _loc3[i].firstChild.nodeValue;
        mov_content.mov_videos.mov_entries["mov_entry" + i].title_txt.colorTo(_global.color_on, 1.000000E-001);
        mov_content.mov_videos.mov_entries["mov_entry" + i].title_txt.text = _loc3[i].attributes.title.toUpperCase();
        mov_content.mov_videos.mov_entries["mov_entry" + i].mov_thumb.loadMovie(_loc3[i].attributes.image);
        mov_content.mov_videos.mov_entries["mov_entry" + i].pos = i;
        if (i == _loc3.length - 1)
        {
            mov_content.mov_videos.mov_entries.alphaTo(100, 3.000000E-001, "linear");
            mov_content.mov_videos.make_scroll();
            mov_content.mov_videos.load_video(0);
        } // end if
        mov_content.mov_videos.mov_entries["mov_entry" + i].mov_hidden.onRollOver = function ()
        {
            this._parent.alphaTo(100, 1);
        };
        mov_content.mov_videos.mov_entries["mov_entry" + i].mov_hidden.onRollOut = function ()
        {
            this._parent.alphaTo(60, 1, "easeOutExpo", 2.000000E-001);
            this._parent.mov_line.alphaTo(100, 1, "easeOutExpo", 2.000000E-001);
        };
        mov_content.mov_videos.mov_entries["mov_entry" + i].mov_hidden.onRelease = function ()
        {
            cont = this._parent.pos;
            mov_content.mov_videos.body_txt.slideTo(890, y, 2.000000E-001, "linear");
            mov_content.mov_videos.title_txt.alphaTo(0, 3.000000E-001, "linear");
            mov_content.mov_videos.mov_video.mov_video_screen.alphaTo(0, 3.000000E-001, "linear");
            mov_content.mov_videos.new_stream.close();
            mov_content.mov_videos.alphaTo(100, 3.000000E-001, "linear", 1.000000E-001, function ()
            {
                mov_content.mov_videos.load_video(cont);
            });
        };
        ++i;
    } // end while
...
main_position = 0;
mov_content.mov_videos.mov_entries.mov_entry._visible = false;
mov_set_buttons.mov_set_button._visible = false;
mov_content.mov_videos.mov_video._alpha = 0;
mov_content.mov_videos.mov_dragger.mov_h_back.colorTo(_global.color_on, 0);
mov_content.mov_videos.mov_video.mov_video_controls.mov_time.colorTo(_global.color_on, 0);
mov_content.mov_videos.mov_video.mov_video_controls.mov_right_controls.mov_volume.mov_bars.colorTo(_global.color_on, 0);
var xml_file = new XML();
xml_file.ignoreWhite = true;
xml_file.contentType = "text/xml";
xml_file.onLoad = function (success)
{
    for (var _loc3 = 0; _loc3 < 50; ++_loc3)
    {
        if (mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3] == undefined)
        {
            limit = _loc3;
            _loc3 = 49;
        } // end if
    ...
    {
        removeMovieClip (mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3]);
    } // end of for
    if (mov_content._parent._parent._parent.relative_pos < 9)
    {
        app = "0" + Math.round(mov_content._parent._parent._parent.relative_pos + 1);
    }
    else
    {
        app = "";
    ...
    var _loc5 = xml_file.firstChild;
    var _loc4 = _loc5.childNodes;
    for (var _loc3 = 0; _loc3 < _loc4.length; ++_loc3)
    {
        mov_content._parent._parent._parent.mov_set_buttons.mov_set_button.duplicateMovieClip("mov_set_button" + _loc3, _loc3);
        mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3]._x = but_x;
        mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].but_txt.text = _loc4[_loc3].attributes.title;
        mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].but_txt.autoSize = true;
        but_x = but_x + (mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].but_txt._width + 12);
        mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].pos = _loc3;
        if (_loc3 == _loc4.length - 1 || _loc4.length == 0)
        {
            mov_content._parent._parent._parent.mov_set_buttons.mov_set_button0.but_txt.colorTo(_global.color_on, 0, "linear", 1.000000E-001);
            if (xml_file.firstChild.childNodes[main_position].childNodes.length > 0)
            {
                mov_content.mov_right.colorTo(_global.color_on, 0);
                mov_content.mov_right.enabled = true;
            } // end if
            but_prev.enabled = false;
            but_prev.mov_line_r.colorTo(16777215, 0);
            if (_loc4.length > 0)
            {
                but_next.enabled = true;
                but_next.mov_line_l.colorTo(_global.color_on, 0);
            } // end if
            recreate_right_panel(0);
            mov_content._parent._parent._parent.mov_set_buttons._visible = true;
            mov_content._parent._parent._parent.mov_set_buttons.alphaTo(100, 6.000000E-001, "linear", 8.000000E-001);
        } // end if
        mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].onRollOver = function ()
        {
            if (this.pos != main_position)
            {
                this.colorTo(10066329, 5.000000E-001, "linear");
            } // end if
        };
        mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].onRollOut = function ()
        {
            if (this.pos != main_position)
            {
        ...
        mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].onRelease = function ()
        {
            if (this.pos != main_position)
            {
                mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + main_position].colorTo(6710886, 5.000000E-001, "linear");
                mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + this.pos].colorTo(_global.color_on, 5.000000E-001, "linear");
                cont = this.pos;
                if (cont == 0)
                {
                    but_prev.enabled = false;
                ...
                if (cont == xml_file.firstChild.childNodes.length - 1)
                {
                ...
                mov_content.mov_videos.body_txt.slideTo(890, y, 2.000000E-001, "linear");
                mov_content.mov_videos.title_txt.alphaTo(0, 3.000000E-001, "linear");
                mov_content.mov_videos.mov_entries.alphaTo(0, 3.000000E-001, "linear");
                mov_content.mov_videos.mov_dragger.alphaTo(0, 3.000000E-001, "linear");
                mov_content.mov_videos.mov_bar.alphaTo(0, 3.000000E-001, "linear");
                mov_content.mov_thumb.alphaTo(0, 3.000000E-001, "linear");
                mov_content.alphaTo(100, 3.000000E-001, "linear", 0, function ()
                {
                    recreate_right_panel(cont);
                });
            } // end if
        };
    } // end of for
};
xml_file.load("videos.xml");
but_next.onRelease = function ()
{
    mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + main_position].colorTo(6710886, 5.000000E-001, "linear");
    cont = main_position;
    ++cont;
    mov_content._parent._parent._parent.mov_set_buttons["mov_set_button" + cont].colorTo(_global.color_on, 5.000000E-001, "linear");
    mov_content.mov_videos.mov_video.mov_video_screen.alphaTo(0, 3.000000E-001, "linear");
    mov_content.mov_videos.new_stream.close();
    mov_content.mov_videos.body_txt.slideTo(890, y, 2.000000E-001, "linear");
    mov_content.mov_videos.title_txt.alphaTo(0, 3.000000E-001, "linear");
    ...
    mov_content.mov_videos.mov_bar.alphaTo(0, 3.000000E-001, "linear");
    mov_content.mov_thumb.alphaTo(0, 3.000000E-001, "linear");
    mov_content.alphaTo(100, 0, "linear", 4.000000E-001, function ()
    {
        recreate_right_panel(cont);
    });
    if (cont == xml_file.firstChild.childNodes.length - 1)
...
{
    align_services();
    delete mov_content.mov_entries.onEnterFrame;
    Mouse.removeListener(mouseListener);
};
receiving.connect("menuConnection");
receiving2 = new LocalConnection();
receiving2.stopMessage = function ()
{
    mov_content.mov_videos.new_stream.close();
    delete mov_content.mov_entries.onEnterFrame;
    Mouse.removeListener(mouseListener);
};
receiving2.connect("stopConnection");
stop ();
