function align_services()
{
    but_prev._x = Math.round(-but_prev._width - 20);
    but_next._x = Math.round(Number(mov_news._parent._parent._parent.xml_file.firstChild.childNodes[mov_news._parent._parent._parent.relative_pos].attributes.or_width) + 20);
} // End of the function
function load_image(imagem, clip)
{
    ...
    {
        clip._alpha = 0;
        mov_news.mov_imgloader._width = 0;
        mov_news.mov_maskloader._width = 0;
        mov_news.mov_maskloader._height = 0;
    };
    _loc1.onLoadProgress = function (m_clip, bytesLoaded, bytesTotal)
    {
        mov_news.mov_imgloader._width = mov_news.mov_imgloader._width + Math.round((Math.round(bytesLoaded / bytesTotal * 280) - mov_news.mov_imgloader._width) / 8);
        if (bytesLoaded / bytesTotal < 5.000000E-001)
        {
            mov_news.mov_imgloader._alpha = 100;
        } // end if
    };
    _loc1.onLoadComplete = function ()
    {
        mov_news.mov_imgloader._width = 280;
        mov_news.mov_imgloader.alphaTo(0, 3.000000E-001, "linear");
        mov_news.mov_maskloader.scaleTo(100, 1);
        clip.alphaTo(100, 1.000000E-001, "linear");
    };
    _loc2.addListener(_loc1);
    _loc2.loadClip(imagem, clip);
} // End of the function
function load_item(new_set, new_pos)
{
    insider_pos = new_pos;
    cont = new_pos + 1;
    load_image(news_xml.firstChild.childNodes[new_set].childNodes[new_pos].attributes.image, mov_news.mov_thumb);
    this.mov_news.txt_view.text = "Image " + cont + " of " + news_xml.firstChild.childNodes[new_set].childNodes.length;
    if (outsider_pos != new_set)
    {
        mov_news.txt_client._y = 10;
        mov_news.txt_date._y = 41;
        mov_news.txt_url._y = 72;
    } // end if
    outsider_pos = new_set;
    if (outsider_pos == 0)
    {
        but_prev.enabled = false;
        but_prev.mov_line_r.colorTo(16777215, 1);
    }
    else
    {
        but_prev.enabled = true;
        but_prev.mov_line_r.colorTo(_global.color_on, 1);
    } // end else if
    if (outsider_pos == news_xml.firstChild.childNodes.length - 1)
    {
        but_next.enabled = false;
        but_next.mov_line_l.colorTo(16777215, 1);
    }
    else
    {
        but_next.enabled = true;
        but_next.mov_line_l.colorTo(_global.color_on, 1);
    } // end else if
    if (news_xml.firstChild.childNodes[outsider_pos].childNodes.length > 0)
    {
        mov_news.mov_right.colorTo(_global.color_on, 0);
        mov_news.mov_right.enabled = true;
    } // end if
    mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + outsider_pos].colorTo(_global.color_on, 1.000000E-001, "linear");
    mov_news.txt_title.alphaTo(100, 5.000000E-001);
    mov_news.txt_client.slideTo(x, 35, 5.000000E-001);
    mov_news.txt_date.slideTo(x, 66, 5.000000E-001);
    mov_news.txt_url.slideTo(x, 97, 5.000000E-001);
    mov_news.txt_description.alphaTo(100, 5.000000E-001);
    mov_news.txt_title.text = news_xml.firstChild.childNodes[new_set].attributes.title;
    mov_news.txt_client.text = news_xml.firstChild.childNodes[new_set].attributes.client;
    mov_news.txt_date.text = news_xml.firstChild.childNodes[new_set].attributes.date;
    mov_news.txt_url.text = news_xml.firstChild.childNodes[new_set].attributes.url;
    if (news_xml.firstChild.childNodes[new_set].attributes.url != "")
    {
        mov_news.mov_url.enabled = true;
    }
    else
    {
        mov_news.mov_url.enabled = false;
    } // end else if
    mov_news.txt_description.text = news_xml.firstChild.childNodes[new_set].attributes.description;
} // End of the function
...
mov_news.mov_right.enabled = false;
mov_news.mov_left.enabled = false;
mov_news.mov_imgloader._alpha = 0;
mov_news.mov_imgloader._width = 0;
mov_news.mov_maskloader._width = 0;
mov_news.mov_maskloader._height = 0;
if (!_global.color_on)
{
    _global.color_on = "0xCC0066";
} // end if
mov_news.mov_imgloader.colorTo(_global.color_on, 0);
mov_news.mov_entries.mov_entry._visible = false;
var news_xml = new XML();
news_xml.ignoreWhite = true;
news_xml.onLoad = function ()
{
    for (var _loc3 = 0; _loc3 < 50; ++_loc3)
    {
        if (mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3] == undefined)
        {
            limit = _loc3;
            _loc3 = 49;
        } // end if
    } // end of for
    for (var _loc3 = 0; _loc3 < limit; ++_loc3)
    {
        removeMovieClip (mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3]);
    } // end of for
    if (mov_news._parent._parent._parent.relative_pos < 9)
    {
        app = "0" + Math.round(mov_news._parent._parent._parent.relative_pos + 1);
    }
    else
    {
        app = "";
    ...
    var _loc5 = news_xml.firstChild;
    var _loc4 = _loc5.childNodes;
    for (var _loc3 = 0; _loc3 < _loc4.length; ++_loc3)
    {
        mov_news._parent._parent._parent.mov_set_buttons.mov_set_button.duplicateMovieClip("mov_set_button" + _loc3, _loc3);
        mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3]._x = but_x;
        mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].but_txt.text = _loc4[_loc3].attributes.title;
        mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].but_txt.autoSize = true;
        but_x = but_x + (mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].but_txt._width + 12);
        mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].pos = _loc3;
        if (_loc3 == _loc4.length - 1)
        {
            mov_news._parent._parent._parent.mov_set_buttons.mov_set_button0.but_txt.colorTo(_global.color_on, 0, "linear", 1.000000E-001);
            if (news_xml.firstChild.childNodes[outsider_pos].childNodes.length > 0)
            {
                mov_news.mov_right.colorTo(_global.color_on, 0);
                mov_news.mov_right.enabled = true;
            ...
            mov_news._parent._parent._parent.mov_set_buttons.alphaTo(100, 6.000000E-001, "linear", 8.000000E-001);
        } // end if
        mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].onRollOver = function ()
        {
            if (this.pos != outsider_pos)
            {
                this.colorTo(10066329, 5.000000E-001, "linear");
            } // end if
        };
        mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].onRollOut = function ()
        {
            if (this.pos != outsider_pos)
            {
        ...
        mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + _loc3].onRelease = function ()
        {
            if (this.pos != outsider_pos)
            {
                mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + outsider_pos].colorTo(6710886, 5.000000E-001, "linear");
                mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + this.pos].colorTo(_global.color_on, 5.000000E-001, "linear");
                if (news_xml.firstChild.childNodes[outsider_pos].childNodes.length > 0)
                {
                    mov_news.mov_right.colorTo(_global.color_on, 3.000000E-001, "linear");
                    mov_news.mov_right.enabled = true;
                }
                else
                {
                    mov_news.mov_right.colorTo(6710886, 3.000000E-001, "linear");
                    mov_news.mov_right.enabled = false;
                } // end else if
                mov_news.mov_left.colorTo(6710886, 3.000000E-001, "linear");
                mov_news.mov_left.enabled = false;
                cont = this.pos;
                mov_news.txt_client.slideTo(x, 50, 2.000000E-001, "linear");
                mov_news.txt_date.slideTo(x, 81, 2.000000E-001, "linear");
                mov_news.txt_url.slideTo(x, 112, 2.000000E-001, "linear");
                mov_news.txt_title.alphaTo(0, 3.000000E-001, "linear");
                mov_news.mov_thumb.alphaTo(0, 3.000000E-001, "linear");
                mov_news.txt_description.alphaTo(0, 3.000000E-001, "linear", 0, function ()
                {
                    load_item(cont, 0);
                });
            } // end if
...
news_xml.load("projects.xml");
mov_news.mov_left.onRelease = function ()
{
    if (insider_pos > 0)
    {
        --insider_pos;
        mov_news.mov_thumb.alphaTo(0, 3.000000E-001, "linear", 0, function ()
        {
            load_item(outsider_pos, insider_pos);
        });
    } // end if
    if (insider_pos == 0)
    {
        this.colorTo(6710886, 3.000000E-001, "linear");
        this.enabled = false;
    } // end if
    mov_news.mov_right.enabled = true;
    mov_news.mov_right.colorTo(_global.color_on, 3.000000E-001);
};
mov_news.mov_right.onRelease = function ()
{
    if (insider_pos < news_xml.firstChild.childNodes[outsider_pos].childNodes.length - 1)
    {
        ++insider_pos;
        mov_news.mov_thumb.alphaTo(0, 3.000000E-001, "linear", 0, function ()
        {
    ...
    mov_news.mov_left.enabled = true;
    mov_news.mov_left.colorTo(_global.color_on, 3.000000E-001);
};
mov_news.mov_url.onRollOver = function ()
{
    mov_news.txt_url.colorTo(_global.color_on, 3.000000E-001, "linear");
};
mov_news.mov_url.onRollOut = function ()
{
    mov_news.txt_url.colorTo(16777215, 3.000000E-001, "linear");
};
mov_news.mov_url.onRelease = function ()
{
    getURL("http://" + news_xml.firstChild.childNodes[outsider_pos].attributes.url, "_blank");
};
receiving = new LocalConnection();
receiving.menuMessage = function ()
{
    align_services();
};
receiving.connect("menuConnection");
but_next.onRelease = function ()
{
    mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + outsider_pos].colorTo(6710886, 5.000000E-001, "linear");
    cont = outsider_pos;
    ++cont;
    mov_news._parent._parent._parent.mov_set_buttons["mov_set_button" + cont].colorTo(_global.color_on, 5.000000E-001, "linear");
    mov_news.mov_left.colorTo(6710886, 3.000000E-001, "linear");
    mov_news.mov_left.enabled = false;
    mov_news.txt_client.slideTo(x, 50, 2.000000E-001, "linear");
    mov_news.txt_date.slideTo(x, 81, 2.000000E-001, "linear");
    ...
    if (cont == news_xml.firstChild.childNodes.length - 1)
    {
        this.enabled = false;
